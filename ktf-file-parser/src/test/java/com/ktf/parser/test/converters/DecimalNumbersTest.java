...
package com.ktf.parser.test.converters;
...
import com.ktf.parser.test.converters.testobjects.DecimalType;
...
public class DecimalNumbersTest extends TestCase {
    ...
    public void testDecimals1() throws IOException {
        ...
        List<DecimalType> res = (ArrayList<DecimalType>) Common.readTest(engine, "Good/NumberFormat.txt");
