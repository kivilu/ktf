...
import com.ktf.parser.annotations.FieldDelimiter;
import com.ktf.parser.annotations.FieldFixedLength;
import com.ktf.parser.annotations.FieldIgnored;
...
public class FieldFactory {
    ...
    public static FieldBase createField( Field fi, Class<?> recordClass, boolean someOptional ) {
         ...
         * 
         * if (attributes.Length > 1) throw new BadUsageException("The field: "
         * + fi.Name +
         * " has more than one FieldAttribute (left only one or none)");
         * 
         * if (attributes.Length == 0 && recordAttribute is
         * FixedLengthRecordAttribute) throw new BadUsageException(
         ...
         * fi.IsDefined(typeof (FieldAlignAttribute), true)) throw new
         * BadUsageException(
        ...
        if (fi.isAnnotationPresent(FieldFixedLength.class)) {
            ...
            FixedLengthRecord fixedLengthRecord = recordClass
                    .getAnnotation(FixedLengthRecord.class);
