...
public class LogFactory {
     ...
     *
     */
    public static OperationLogVO createOperationLog( LogType logType, String userId, String bussinessName,
            String clazzName, String methodName, String msg, LogStatus succeed ) {
    ...
    public static LoginLogVO createLoginLog( LogType logType, String userId, String msg, String ip ) {
        ...
        loginLog.setGmtCreate(DateTimeKit.date());
        loginLog.setGmtUpdate(loginLog.getGmtCreate());
