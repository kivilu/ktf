...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("com.kivi.framework.web.controller.BaseController");
        ...
        this.packageName = basePackage + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\" + basePackage.replace(".", "\\") +
