...
package com.ktf.parser.fields;

import java.io.IOException;
import java.lang.reflect.Field;

import com.ktf.parser.annotations.FieldConverter;
import com.ktf.parser.annotations.FieldNullValue;
import com.ktf.parser.converters.ConvertHelpers;
import com.ktf.parser.converters.ConverterBase;
import com.ktf.parser.core.ExtractedInfo;
    ...
    public Object extractValue( LineInfo line ) throws IOException {
        if (this.inNewLine) {
            ...
            if (line.getLineStr() == null) {
                // throw new BadUsageException("End of stream found parsing the
    ...
    public Object createValueForField( Object fieldValue ) {
        ...
        if (fieldValue == null) {
            ...
            if (convertProvider == null) {
                // TODO what to do in this case: we're trying to convert the
                // extracted string to a field
        ...
        if (convertProvider == null) {
            if (stringField) {
                ...
                if (fieldString.length() == 0) {
                    ...
                    // TODO what to do in this case: we're trying to convert the
                    // extracted string to a field
                    // val = Convert.ChangeType(fieldString.extractedString(),
                    // fieldInfo., null);
