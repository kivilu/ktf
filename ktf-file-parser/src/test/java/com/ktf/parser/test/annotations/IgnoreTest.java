 ...
 */
package com.ktf.parser.test.annotations;
...
import com.ktf.parser.test.converters.testobjects.SampleCustomer;
import com.ktf.parser.test.converters.testobjects.SampleCustomer2;
import com.ktf.parser.test.converters.testobjects.SampleCustomer3;
...
public class IgnoreTest extends TestCase {
    public void testIgnoreBoth() throws IOException {
        ...
        List<SampleCustomer> res = (ArrayList<SampleCustomer>) Common.readTest(engine, "Data/customers.txt");
    ...
    public void testIgnoreLast() throws IOException {
        ...
        @SuppressWarnings( "unchecked" )
        List<SampleCustomer2> res = (ArrayList<SampleCustomer2>) Common.readTest(engine, "Data/customers2.txt");
    ...
    public void testIgnoreFirst() throws IOException {
        ...
        @SuppressWarnings( "unchecked" )
        List<SampleCustomer3> res = (ArrayList<SampleCustomer3>) Common.readTest(engine, "Data/customers3.txt");
    ...
    public void testIgnoreCommentedLines() throws IOException {
        ...
        @SuppressWarnings( "unchecked" )
        List<SampleCustomer> res = (ArrayList<SampleCustomer>) Common.readTest(engine, "Data/customers-comments.txt");
