...
public class ContextConfig {
    ...
    private String  projectPath      = "D:\\ktf";   // 模板输出的项目目录
    private String  basePackage      = "com.kivi."; // 包名称
    ...
    public void setBizEnName( String bizEnName ) {
        ...
        this.bizEnBigName = StrKit.firstCharToUpperCase(this.bizEnName);
    }
    ...
    public void setBasePackage( String basePackage ) {
        ...
        if (!StrKit.endWith(basePackage, ".", true))
            basePackage += ".";
