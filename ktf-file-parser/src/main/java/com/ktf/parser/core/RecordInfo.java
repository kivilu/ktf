...
import com.ktf.parser.annotations.IgnoreCommentedLines;
import com.ktf.parser.annotations.IgnoreEmptyLines;
import com.ktf.parser.annotations.IgnoreFirst;
import com.ktf.parser.annotations.IgnoreLast;
import com.ktf.parser.engines.LineInfo;
import com.ktf.parser.enums.RecordCondition;
import com.ktf.parser.fields.FieldBase;
import com.ktf.parser.fields.FieldFactory;
import com.ktf.parser.fields.FixedLengthField;
import com.ktf.parser.helpers.ConditionHelper;
import com.ktf.parser.helpers.StringHelper;
import com.ktf.parser.interfaces.NotifyRead;
import com.ktf.parser.interfaces.NotifyWrite;
...
public final class RecordInfo<T> {
     ...
     * 
     * @param line
     *            current text line extracted from file
    ...
    public T strToRecord( LineInfo line ) {
        ...
        try {
            ...
            for (int i = 0; i < fieldCount; i++) {
                ...
                // Field f =
                // record.getClass().getDeclaredField(fields[i].getFieldInfo().getName());
        ...
        // try
        // {
        // // Asign all values via dinamic method that creates an object and
        // assign values
        // return mCreateHandler(mValues);
        // }
        // catch (InvalidCastException)
        // {
        // // Occurrs when the a custom converter returns an invalid value for
        // the field.
        // for (int i = 0; i < mFieldCount; i++)
        // {
        // if (mValues[i] != null && !
        // mFields[i].mFieldType.IsInstanceOfType(mValues[i]))
        // throw new ConvertException(null, mFields[i].mFieldType,
        // mFields[i].mFieldInfo.Name, line.mReader.LineNumber, -1, "The
        // converter for the field: " + mFields[i].mFieldInfo.Name + " returns
        // an object of Type: " + mValues[i].GetType().Name + " and the field is
        // of type: " + mFields[i].mFieldType.Name);
        // }
        // return null;
        // }
    }
     ...
     * @param record
     *            the record object
     * @return string representation of the record object, respecting rules
     *         defined
    ...
    private void initFields() {
        ...
        if (fieldCount == 0) {
            throw new IllegalArgumentException(
                    "The record class " + recordClass.getName() + " don't contains any field.");
        }
    }
     ...
     * 
     * @param fields
     *            current fields of the record class, acquired via reflection
     * @param recordClass
     *            the record class
