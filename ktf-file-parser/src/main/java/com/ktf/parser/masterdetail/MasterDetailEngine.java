 ...
 */
package com.ktf.parser.masterdetail;
...
import com.ktf.parser.core.RecordInfo;
...
public class MasterDetailEngine<MT, DT> extends EngineBase<DT> {
    ...
    public MasterDetailEngine( Class<MT> masterRecordClass, Class<DT> detailRecordClass,
                               MasterDetailSelector recordSelector ) {
    ...
    public MasterDetailEngine( Class<MT> masterRecordClass, Class<DT> detailRecordClass, CommonSelector action,
                               String selector ) {
        super(detailRecordClass);
        this.masterInfo = new RecordInfo<MT>(masterRecordClass);
        final CommonInternalSelector sel = new CommonInternalSelector(action, selector,
                masterInfo.isIgnoreEmptyLines() || recordInfo.isIgnoreEmptyLines());
    ...
    private void writeStream( OutputStreamWriter osr, List<MasterDetails<MT, DT>> records, int maxRecords )
            throws IOException {
