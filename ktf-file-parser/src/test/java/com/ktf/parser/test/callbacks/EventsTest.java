...
package com.ktf.parser.test.callbacks;

import java.io.IOException;

import com.ktf.parser.engines.EngineBase;
import com.ktf.parser.engines.FileHelperEngine;
import com.ktf.parser.events.AfterReadRecordEventArgs;
import com.ktf.parser.events.AfterReadRecordHandler;
import com.ktf.parser.events.AfterWriteRecordEventArgs;
import com.ktf.parser.events.AfterWriteRecordHandler;
import com.ktf.parser.events.BeforeReadRecordEventArgs;
import com.ktf.parser.events.BeforeReadRecordHandler;
import com.ktf.parser.events.BeforeWriteRecordEventArgs;
import com.ktf.parser.events.BeforeWriteRecordHandler;
    ...
    public void testBeforeRead() {
        ...
        fileEngine.setBeforeReadRecordHandler(
                new BeforeReadRecordHandler<Customer>() {
                    public void handleBeforeReadRecord( EngineBase<Customer> engine,
                            BeforeReadRecordEventArgs<Customer> e ) {
                        engineTester(engine);
        ...
        fileEngine.setAfterReadRecordHandler(
                new AfterReadRecordHandler<Customer>() {
                    public void handleAfterReadRecord( EngineBase<Customer> engine,
                            AfterReadRecordEventArgs<Customer> e ) {
                        engineTester(engine);
    ...
    public void testWriteRecord() {
        ...
        fileEngine.setBeforeWriteRecordHandler(
                new BeforeWriteRecordHandler<Customer>() {
                    public void handleBeforeWriteRecord( EngineBase<Customer> engine,
                            BeforeWriteRecordEventArgs<Customer> e ) {
                        engineTester(engine);
        ...
        fileEngine.setAfterWriteRecordHandler(
                new AfterWriteRecordHandler<Customer>() {
                    public void handleAfterWriteRecord( EngineBase<Customer> engine,
                            AfterWriteRecordEventArgs<Customer> e ) {
                        engineTester(engine);
