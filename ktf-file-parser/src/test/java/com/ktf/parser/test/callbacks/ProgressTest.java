...
import com.ktf.parser.enums.ProgressMode;
import com.ktf.progress.ProgressChangeHandler;
import com.ktf.progress.ProgressEventArgs;
...
public class ProgressTest extends CallbacksBase {
    /*
     * These tests are not ideal because they rely on knowledge of the behavior
     * of the FileHelper engine. We know that the read and the write both notify
     * at the start and then once for each record. Also, when doing percentage,
     * read is not invoked at all. There are 4 records.
     * 
     */
