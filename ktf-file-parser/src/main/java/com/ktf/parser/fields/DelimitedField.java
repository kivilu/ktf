...
import com.ktf.parser.enums.MultilineMode;
import com.ktf.parser.enums.QuoteMode;
    ...
    protected ExtractedInfo extractFieldString( LineInfo line ) {
        ...
        if (quoteChar == '\0') {
            ...
            if (line.startsWith(quotedStr)) {
                try {
                    return StringHelper.extractQuotedString(line, quoteChar,
            ...
            if (sepPos == -1) {
                if (this.isNextOptional() == false) {
                    ...
                    if (isFirst() && line.isEmptyFromPos())
                        ...
                        msg = "The delimiter '" + this.separator + "' " +
