 ...
 */
package com.ktf.parser.test.masterdetail;

import java.io.IOException;
import java.util.List;

import com.ktf.parser.masterdetail.CommonSelector;
import com.ktf.parser.masterdetail.MasterDetailEngine;
import com.ktf.parser.masterdetail.MasterDetails;
import com.ktf.parser.test.common.Common;
import com.ktf.parser.test.types.customers.CustomersVerticalBar;
import com.ktf.parser.test.types.orders.OrdersVerticalBar;
...
public class MasterDetail2Test extends TestCase {
    ...
    public void testCustomerOrdersRead() throws IOException {
        engine = new MasterDetailEngine<CustomersVerticalBar, OrdersVerticalBar>(CustomersVerticalBar.class,
                OrdersVerticalBar.class, CommonSelector.DetailIfContains, "@");

        List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>> res = (List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>>) Common
                .readTest(engine, "Good/MasterDetail2.txt");
    ...
    public void testCustomerOrdersRead2() throws IOException {
        engine = new MasterDetailEngine<CustomersVerticalBar, OrdersVerticalBar>(CustomersVerticalBar.class,
                OrdersVerticalBar.class, CommonSelector.MasterIfContains, "@");

        List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>> res = (List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>>) Common
                .readTest(engine, "Good/MasterDetail3.txt");
