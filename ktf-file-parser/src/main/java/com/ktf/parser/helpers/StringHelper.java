...
package com.ktf.parser.helpers;
...
public class StringHelper {
    ...
    private static String getToString( Object o ) throws ClassNotFoundException {
        ...
        return org.apache.commons.lang3.builder.ToStringBuilder.reflectionToString(o, ToStringStyle.MULTI_LINE_STYLE);
    }
    ...
    public static ExtractedInfo extractQuotedString( LineInfo line, char quoteChar, boolean allowMultiline )
            throws IOException {
        if (line.isEol()) {
