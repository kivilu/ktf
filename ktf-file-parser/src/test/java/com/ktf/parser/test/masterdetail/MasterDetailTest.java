...
import com.ktf.parser.masterdetail.MasterDetailSelector;
import com.ktf.parser.masterdetail.MasterDetails;
import com.ktf.parser.masterdetail.RecordAction;
...
public class MasterDetailTest extends TestCase {
    ...
    public void testCustomersOrderRead() throws IOException {
        ...
        List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>> res = (List<MasterDetails<CustomersVerticalBar, OrdersVerticalBar>>) Common
                .readTest(engine, "Good/MasterDetail1.txt");
