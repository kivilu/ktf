...
package com.ktf.parser.converters;
            ...
            try {
                ...
                if (trueString == null) {
                    ...
                    if (testTo.equals(trueStringLower) || testTo.trim().equals(trueStringLower))
                        ...
                        // throw new ConvertException(from, typeof(bool), "The
                        // string: " + from + " cant be recognized as boolean
                        // using the true/false values: " + mTrueString + "/" +
                        // mFalseString);
