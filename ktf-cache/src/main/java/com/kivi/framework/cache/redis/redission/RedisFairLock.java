 ...
 * guarantees that Redisson client threads will acquire it in is 
 * same order they requested it. It has same interface as simple Lock object.
 * 
