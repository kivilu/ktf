...
public class SM4 {
    ...
    public byte[] sm4_crypt_ecb_V2( SM4Context ctx, byte[] input ) throws Exception {
        if (input == null) {
            throw new Exception("input is null!");
        }
    ...
    public byte[] sm4_crypt_cbc_V2( SM4Context ctx, byte[] iv, byte[] input ) throws Exception {
        if (iv == null || iv.length != 16) {
            throw new Exception("iv error!");
        }
